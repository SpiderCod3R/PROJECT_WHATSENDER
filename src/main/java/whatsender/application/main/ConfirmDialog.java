...
public class ConfirmDialog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnClose = new whatsender.application.swing.custom_button.SwingCustomButton();
        ...
        jLabel1.setText("Ação Irreversível");

        btnSendMessage.setBackground(new java.awt.Color(0, 153, 153));
        btnSendMessage.setForeground(new java.awt.Color(255, 255, 255));
        btnSendMessage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/send.png"))); // NOI18N
        btnSendMessage.setText("Confirmar e Enviar");
        btnSendMessage.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N

        btnClose.setBackground(new java.awt.Color(205, 28, 28));
        ...
        jLabel2.setText("Deseja enviar esta(s) mensagems?");
    ...
    private whatsender.application.swing.custom_button.SwingCustomButton btnClose;
