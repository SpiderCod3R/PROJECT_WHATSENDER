...
public class DefinirPacote extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPacoteStandard = new whatsender.application.swing.Button();
        btnPacoteInter2 = new whatsender.application.swing.Button();
        btnPacoteInter1 = new whatsender.application.swing.Button();
        btnPacoteInfinito = new whatsender.application.swing.Button();
        jLabel1 = new javax.swing.JLabel();
        cardPackage4 = new whatsender.application.component.CardPackage();
        cardPackage1 = new whatsender.application.component.CardPackage();
        cardPackage2 = new whatsender.application.component.CardPackage();
    ...
    private whatsender.application.swing.Button btnPacoteInfinito;
    private whatsender.application.swing.Button btnPacoteInter1;
    private whatsender.application.swing.Button btnPacoteInter2;
    private whatsender.application.swing.Button btnPacoteStandard;
    private whatsender.application.component.CardPackage cardPackage1;
    private whatsender.application.component.CardPackage cardPackage2;
    private whatsender.application.component.CardPackage cardPackage3;
    private whatsender.application.component.CardPackage cardPackage4;
